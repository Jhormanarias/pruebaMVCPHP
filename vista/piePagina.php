...
<footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="https://ganantech.negocio.site/?utm_source=gmb&utm_medium=referral">GañanTech</a>.</strong>
    All rights reserved.
...
<!-- AdminLTE App -->
<script src="<?php echo RUTA;?>js/adminlte.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo RUTA;?>js/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo RUTA;?>js/pages/dashboard.js"></script>
</body>
</html>